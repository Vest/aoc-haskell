...
tests' =
  test
    [ "day9" ~: "solution1(nothing)" ~: "nothing" ~=? "nothing",
      ...
      "day9" ~: "extractIndefinitely((27x12)(20x12)(13x14)(7x10)(1x12)A)" ~: replicate 241920 'A' ~=? Day9.extractIndefinitely "(27x12)(20x12)(13x14)(7x10)(1x12)A",
      "day9" ~: "extractIndefinitely((25x3)(3x3)ABC(2x3)XY(5x2)PQRSTX(18x9)(3x2)TWO(5x7)SEVEN)" ~: 445 ~=? (length . Day9.extractIndefinitely $ "(25x3)(3x3)ABC(2x3)XY(5x2)PQRSTX(18x9)(3x2)TWO(5x7)SEVEN")
    ]
