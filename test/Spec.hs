...
tests' =
  test
    [ "test1" ~: "parseStep(R1)" ~: Just (Lib.Right 1) ~=? (Lib.parseStep "R1"),
      ...
      "test8" ~: "moveSteps a circle" ~: (West, Position 0 0) ~=? Lib.moveSteps 5 (West, snd (Lib.moveSteps 5 (South, snd (Lib.moveSteps 5 (East, snd (Lib.moveSteps 5 (North, Position 0 0))))))),
      "test9" ~: "movement(R2, L3)" ~: (North, Position 3 2) ~=? Lib.movement (North, (Position 0 0)) [Lib.Right 2, Lib.Left 3]
    ]
